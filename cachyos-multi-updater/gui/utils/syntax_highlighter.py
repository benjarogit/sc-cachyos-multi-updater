...
class ConsoleSyntaxHighlighter(QSyntaxHighlighter):
    ...
    def __init__(self, parent=None):
        ...
        success_pattern = QRegularExpression(
            r"✓|✅|success|erfolgreich|completed|done|finished"
        )
        ...
        error_pattern = QRegularExpression(
            r"✗|❌|error|fehler|failed|failure|warnung|warning"
        )
        ...
        package_pattern = QRegularExpression(
            r"\b(pacman|yay|paru|flatpak|cursor|adguard)\b"
        )
